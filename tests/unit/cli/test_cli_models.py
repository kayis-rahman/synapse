...
class TestCLIModelsCommand:
    ...
    def test_list_models(self, tmp_path):
        ...
        runner = CliRunner()
        result = runner.invoke(app, ["models", "list", "--config", str(config_path)])
    ...
    def test_download_model(self, tmp_path):
        ...
        runner = CliRunner()
        result = runner.invoke(app, ["models", "download", "bge-m3", "--config", str(config_path)])
    ...
    def test_delete_model(self, tmp_path):
        ...
        runner = CliRunner()
        result = runner.invoke(app, ["models", "delete", "bge-m3", "--config", str(config_path)])
    ...
    def test_validate_model(self, tmp_path):
        ...
        runner = CliRunner()
        result = runner.invoke(app, ["models", "validate", "bge-m3", "--config", str(config_path)])
    ...
    def test_model_info(self, tmp_path):
        ...
        runner = CliRunner()
        result = runner.invoke(app, ["models", "info", "bge-m3", "--config", str(config_path)])
    ...
    def test_filter_models(self, tmp_path):
        ...
        result = runner.invoke(app, ["models", "list", "--type", "quantized", "--config", str(config_path)])
    ...
    def test_search_models(self, tmp_path):
        ...
        runner = CliRunner()
        result = runner.invoke(app, ["models", "search", "bge", "--config", str(config_path)])
    ...
    def test_progress_reporting(self, tmp_path):
        ...
        result = runner.invoke(app, ["models", "download", "bge-m3", "--verbose", "--config", str(config_path)])
    ...
    def test_error_handling(self, tmp_path):
        ...
        result = runner.invoke(app, ["models", "info", "nonexistent-model", "--config", str(config_path)])
    ...
    def test_concurrent_operations(self, tmp_path):
        ...
        result1 = runner.invoke(app, ["models", "list", "--config", str(config_path)])
        result2 = runner.invoke(app, ["models", "list", "--config", str(config_path)])
